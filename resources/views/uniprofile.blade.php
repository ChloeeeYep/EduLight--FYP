...
<body>
    <div class="container light-style flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center py-3 mb-4" style="padding-bottom: 0px !important">
          <a href="{{ route('unihome') }}" class="btn-back" style="font-size: 20px; color: black; background-color: white; border-color:white;">
        ...
        <div class="card overflow-hidden">
            <div class="row no-gutters row-bordered row-border-light">
                ...
                <div class="col-md-9">
                <form method="POST" action="{{ route('uniprofile.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" maxlength="100" value="{{ old('name') ?? $user->name }}">
                                </div> -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="" {{ is_null($user->country) ? 'selected' : '' }}>Select Country</option>
                                        @foreach ($countries as $code => $name)
                                            <option name="country" value="{{ $code }}" {{ $user->country == $code ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
