...
<head>
  ...
  <!--- custom css link-->
  <link rel="stylesheet" href="{{ URL::asset('asset/css/userorder.css') }}">
        ...
        <div class="order-tracking-container">
            @if($orders->isEmpty())
                <div class="no-data-message">
                    <h2 class="no-data-title">No Orders Found</h2>
                    <p class="no-data-text">Currently, there are no orders to display. Please check back later or explore our courses.</p>
                </div>
            @else
                    ...
                    <div class="order-card">
                        ...
                        <div class="order-body">
                            ...
                            @foreach ($order->orderItems as $index => $item)
                                <a href="{{ route('coursedetailpurchase', ['item' => $item->courseId]) }}" class="order-item-link">
