        ...
        <div class="container">
            <div class="details-container">
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content"><img src="/images/{{ $item->image }}" style="width:160px;height:110px;"></span>        
                </div>
				<hr>

                <div class="detail-group">
                    <span class="detail-label">Category:</span> 
                    <span class="detail-content">{{ $item->category }}</span>        
                </div>
				<hr>
                ...
                <div class="detail-group">
					...
					<span class="detail-content" style="width: 84%;">{{ $item->introduction }}</span>
				</div>
				

				@if(!empty($item->title1))
				<hr>
				<div class="detail-group">
                    <span class="detail-label">Title1:</span> 
                    <span class="detail-content">{{ $item->title1 }}</span>               
                </div>
				@endif

				@if(!empty($item->description1))
				<hr>          
                <div class="detail-group">
                    <span class="detail-label">Descirption1:</span>
                    <textarea class="detail-content" readonly disabled>{{ $item->description1 }}</textarea>
                </div>	
				@endif	
            </div>
        </div>
