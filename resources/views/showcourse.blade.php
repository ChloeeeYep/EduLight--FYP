        ...
        <div class="container">
            <div class="details-container">
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content"><img src="/images/{{ $item->photo }}" style="width:160px;height:110px;"></span>        
                </div>
				<hr>
                ...
                <div class="detail-group">
                    <span class="detail-label">Descirption:</span>
                ...
                <div class="detail-group">
					...
					<span class="detail-content">RM {{ $item->price }}</span>
				</div>
				<hr>

				<div class="detail-group">
					<span class="detail-label">Instrutor:</span>
					<span class="detail-content">{{ $instructorName  }}</span>
				</div>
				<hr>
				...
				<div class="detail-group">
					...
					<span class="detail-content">{{ $item->duration }}</span>
				</div>
				<hr>
				...
				<div class="detail-group">
                    ...
                    <span class="detail-content">{{ $item->lesson }}</span>        
                </div>  
				<hr>

				<div class="detail-group">
                    <span class="detail-label">Language:</span>
                    <span class="detail-content">{{ $item->language }}</span>        
                </div>
                <hr>  

                <div class="detail-group">
                    <span class="detail-label">Learn 1:</span>
                    <textarea class="detail-content" readonly disabled>{{ $item->learn1 }}</textarea>     
                </div> 
                <hr>

                <div class="detail-group">
                    <span class="detail-label">Learn 2:</span>
                    <textarea class="detail-content" readonly disabled>{{ $item->learn2 }}</textarea>    
                </div> 
                <hr>

                <div class="detail-group">
                    <span class="detail-label">Learn 3:</span>
                    <textarea class="detail-content" readonly disabled>{{ $item->learn3 }}</textarea>      
                </div> 
            </div>
        </div>
    </section>
