...
<body>
	...
	<section id="content">
		...
		<form action="{{route('updatetutorial' , $item->id)}}" method="POST">
			@csrf
			@method('PUT')
			<div class="container">
				<div class="form-container">
					...
					<form>
						...
						<div class="form-group">
							...
							<input type="text" id="name" name="name" value="{{ $item->name }}" maxlength="250" required>
						</div>
						...
						<div class="form-group">
							...
							<textarea id="example" name="example" required>{{ $item->example }}</textarea>
						</div>

						<div class="form-group">
							<label for="topic">Question<span class="optional">*</span></label>
							<input type="text" id="game" name="question" value="{{ $item->question }}" maxlength="250" required>
						</div> 

						<div class="form-group">
							<label for="details">Correct Answer<span class="optional">*</span></label>
							<input type="text" id="option1" name="option1" value="{{ $item->option1 }}" maxlength="250" required>
						</div> 

						<div class="form-group">
							<label for="details">Wrong Answer<span class="optional">*</span></label>
							<input type="text" id="option2" name="option2" value="{{ $item->option2 }}" maxlength="250" required>
						</div> 
