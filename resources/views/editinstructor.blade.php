...
<body>
	...
	<section id="content">
		...
		<form action="{{route('updateinstructor' , $item->id)}}" method="POST" enctype="multipart/form-data">
			@csrf
			@method('PUT')
			<div class="container">
				<div class="form-container">
					...
					<form>
						...
						<div class="form-group">
							<label for="name">Name<span class="optional">*</span></label>
							<input type="text" id="name" maxlength="250" name="name" value="{{ $item->name }}" required>
						</div>

                        <div class="form-group">
							<label for="title">Title<span class="optional">*</span></label>
							<input type="text" id="title" maxlength="250" name="title" value="{{ $item->title }}" required>
						</div>

                        <div class="form-group">
							<label for="about">About<span class="optional">*</span></label>
							<textarea id="about" name="about" required>{{ $item->about }}</textarea>
						</div>  																				
