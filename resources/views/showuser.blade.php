        ...
        <div class="container">
            <div class="details-container">
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content">{{ $item->email }}</span>        
                </div>
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content">{{ $item->birthday }}</span>               
                </div>
                @endif
                ...
                <hr>
                    <div class="detail-group">
                        ...
                        <span class="detail-content">{{ $countries[$item->country] ?? 'Not Available' }}</span>               
                    </div>
                @endif
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content">{{ $item->phone }}</span>               
                </div>
                @endif
                ...
                <div class="detail-group">
					...
					<textarea class="detail-content" readonly disabled>{{ $item->bio }}</textarea>
				</div>  
                @endif
