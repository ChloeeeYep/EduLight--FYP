        ...
        <div class="container">
            <div class="details-container">
                ...
                <div class="detail-group">
					...
					<span class="detail-content">{{ $item->correct }}</span>
				</div>
				<hr>

				<div class="detail-group">
					<span class="detail-label">Wrong Answer1:</span>
					<span class="detail-content">{{ $item->wrong1 }}</span>
				</div>
				<hr>


				<div class="detail-group">
                    <span class="detail-label">Wrong Answer2:</span>
                    <span class="detail-content">{{ $item->wrong2 }}</span>        
                </div>  

				@if(!empty($item->wrong3))
				<hr>
					<div class="detail-group">
						<span class="detail-label">Wrong Answer3:</span>
						<span class="detail-content">{{ $item->wrong3 }}</span>
					</div>
				@endif
            </div>
        </div>
