        ...
        <div class="container">
            <div class="details-container">
                ...
                <div class="detail-group">
                    ...
                    <span class="detail-content"><img src="/images/{{ $item->image }}" style="width:110px;height:120px;"></span>        
                </div>
				<hr>
                ...
                <div class="detail-group">
					...
					<textarea class="detail-content" readonly disabled>{{ $item->about }}</textarea>
				</div>        			
            </div>
        </div>
    </section>
